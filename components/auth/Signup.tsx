              ...
              <form onSubmit={handleSignup} className="space-y-6">
                ...
                <div className="flex items-start">
                  <input
                    id="terms"
                    type="checkbox"
                    className="w-4 h-4 bg-gray-700 border-gray-600 rounded text-purple-600 focus:ring-purple-500 focus:ring-offset-0 mt-0.5"
                    required
                  />
              ...
              <form onSubmit={handleConfirmation} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-4 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-center text-2xl tracking-[0.5em] font-mono"
                    placeholder="000000"
                    required
                    maxLength={6}
                  />
